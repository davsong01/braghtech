            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group mb-3">
                        ...
                        <input type="text" id="title" class="form-control" name="title" value="{{ $partner->title ?? old('title')}}" placeholder="Title" required>
                    </div>
                    @if(isset($partner->image ))
                    <div class="col-md-12" style="display: flex;padding: 0px;">
                        <div class="col-md-2" style="padding: 0;">
                            <img src="{{ $partner->image ?? ''}}" alt="" style="width: 90px;margin-bottom: 15px;"> <br>
                        </div>
                        <div class="col-md-10" style="padding-right: 0;">
                            <div class="form-group mb-3">
                                <label for="section1_image">Replace Partner Image</label>
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <select class="custom-select" id="order" name="order" required>
                            ...
                            <option value="{{ $order }}" {{ $partner->order == $order ? 'selected' : ''}}>{{$order}}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
