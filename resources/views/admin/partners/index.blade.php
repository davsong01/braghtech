...
@section('content')
    <div class="col-12">
        <div class="row align-items-center my-4">
            <div class="col">
                <h2 class="h3 mb-0 page-title">Partners</h2>
                @include('includes.alerts')
            </div>
        </div>
        <div class="row align-items-center my-4">
            <div class="col-auto">
                <a href="{{ route('partner.create') }}"><button type="button" class="btn btn-primary"><span class="fe fe-plus fe-12 mr-2"></span>Add new</button></a>
            </div>
        </div>
                ...
                <table class="table table-borderless table-hover datatable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $admin->title }}</td>
                            <td>
                                <img src="{{ $admin->image }}" alt="" style="width:140px;height:70px">
                            </td>
                            <td>{{ $admin->order }}</td>
